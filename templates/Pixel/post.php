    ...
    <main class="col-lg-8">
      ...
      <article class="px-article">
        ...
        <div class="px-share-bar">
          ...
          <button class="px-share-copy" onclick="navigator.clipboard&&navigator.clipboard.writeText('<?= htmlspecialchars($shareUrl, ENT_QUOTES) ?>').then(function(){var b=this;b.textContent='Skopiowano!';setTimeout(function(){b.textContent='Kopiuj link';},2000)}.bind(this))" type="button">
